...
const COMPLIANCE_SYSTEM =
  "You are a FINRA and CFPB compliance specialist for mortgage advertising. " +
...
function buildAuditPrompt(content: string, platform: string): string {
